...
module.exports = {
    ...
    createAutoReport: async (settings) => {
        ...
        try {
          ...
          console.log ("Error trying to write settings");
        }
        ...
        async function genReport() {
            ...
            prefix = "/tmp/reports";
            fs.access(prefix), function (error) {
              if (error) {
                 prefix = "/tmp/reports";
              }
            }
            png = `${prefix}/${fileprefix}_${today}.png`;
            pdf = `${prefix}/${fileprefix}_${today}.pdf`;
            ...
            transporter.sendMail(message, (err, info) => {
                if (err) {
                    ...
                    console.log('Failed Mailing report - ' + subject + ': ' + err.message);
            ...
            var result = findRemoveSync(prefix, {
                age: { seconds: 86400 },
                extensions: ['.png', '.pdf'],
                limit: 100
            })            ;
